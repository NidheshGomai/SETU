...
# Configure PyTorch to safely load ultralytics models
...
def generate_frames():
    ...
    # Use absolute path to ensure VideoCapture finds the file
    video_path = r"E:\kjsce\Hackathons\Setu\cityRoad_potHoles-side.mp4"
